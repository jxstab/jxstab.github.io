document.addEventListener('DOMContentLoaded', () => {
    ...
    function init() {
        ...
        window.APP_STATE = { phones, phoneSelect, phoneImage, wrapperBg, updatePhone };
        ...
        document.querySelectorAll('[data-translate-key]').forEach(el => {
            ...
            if (translations[lang] && translations[lang][key]) {
                ...
                if (textNode) {
                    ...
                    el.querySelector('.btn-text').textContent = translations[lang][key];
                } else {
    ...
    function onDragMove(e) {
        ...
        const distance = Math.min(35, Math.hypot(deltaX, deltaY));
